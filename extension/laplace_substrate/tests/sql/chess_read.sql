...
BEGIN
    ...
    INSERT INTO attestations
        (id, subject_id, type_id, object_id, source_id, context_id,
         ...
         sum_score_fp1e9, opponent_rd_fp1e9)
    VALUES
        (laplace_hash128_blake3('t2/g1w'), g1, hw, tal,  src, NULL, 2, now(), 1, 1000000000, 30000000000),
        (laplace_hash128_blake3('t2/g1b'), g1, hb, botv, src, NULL, 2, now(), 1, 1000000000, 30000000000),
        (laplace_hash128_blake3('t2/g1r'), g1, hr, r_white, src, NULL, 2, now(), 1, 1000000000, 30000000000),
        (laplace_hash128_blake3('t2/g2w'), g2, hw, botv, src, NULL, 2, now(), 1, 1000000000, 30000000000),
        (laplace_hash128_blake3('t2/g2b'), g2, hb, tal,  src, NULL, 2, now(), 1, 1000000000, 30000000000),
        (laplace_hash128_blake3('t2/g2r'), g2, hr, r_white, src, NULL, 2, now(), 1, 1000000000, 30000000000),
        (laplace_hash128_blake3('t2/g3w'), g3, hw, tal,  src, NULL, 2, now(), 1, 1000000000, 30000000000),
        (laplace_hash128_blake3('t2/g3b'), g3, hb, spas, src, NULL, 2, now(), 1, 1000000000, 30000000000),
        (laplace_hash128_blake3('t2/g3r'), g3, hr, r_draw, src, NULL, 2, now(), 1, 1000000000, 30000000000),
        (laplace_hash128_blake3('t2/g4w'), g4, hw, tal,  src, NULL, 2, now(), 1, 1000000000, 30000000000),
        (laplace_hash128_blake3('t2/g4b'), g4, hb, botv, src, NULL, 2, now(), 1, 1000000000, 30000000000),
        -- an Elo tag whose surface cannot be rendered back to digits
        (laplace_hash128_blake3('t2/rat'), tal, hrat, elo, src, g1, 2, now(), 1, 1000000000, 30000000000);
    ...
    VALUES
        (laplace_hash128_blake3('t2/plies/san0'), pl_p0, relation_type_id('HAS_SAN'),
             pl_sa, src, pl_game, 2, now(), 1, 1000000000, 30000000000),
        (laplace_hash128_blake3('t2/plies/san1'), pl_p1, relation_type_id('HAS_SAN'),
             pl_sb, src, pl_game, 2, now(), 1, 1000000000, 30000000000),
        ...
        (laplace_hash128_blake3('t2/plies/other'), pl_p0, relation_type_id('HAS_SAN'),
             pl_sc, src, g1, 2, now(), 1, 1000000000, 30000000000);
