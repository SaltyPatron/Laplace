...
DECLARE
    ...
    sense2   bytea := laplace_hash128_blake3('test/chat_loop/sense2');
    sense3   bytea := laplace_hash128_blake3('test/chat_loop/sense3');
...
BEGIN
    ...
    VALUES
      ...
      (consensus_id(w_d, k_sense, sense1),        w_d,     k_sense,   sense1,  neutral + 150000000000, sharp_rd, 60000000, 2, now()),
      (consensus_id(w_c, k_sense, sense2),        w_c,     k_sense,   sense2,  neutral + 150000000000, sharp_rd, 60000000, 2, now()),
      (consensus_id(sense2, k_senseof, synset2),  sense2,  k_senseof, synset2, neutral + 150000000000, sharp_rd, 60000000, 2, now()),
      (consensus_id(w_h, k_sense, sense3),        w_h,     k_sense,   sense3,  neutral + 150000000000, sharp_rd, 60000000, 2, now()),
      (consensus_id(sense3, k_senseof, synset3),  sense3,  k_senseof, synset3, neutral + 150000000000, sharp_rd, 60000000, 2, now()),
