        ...
        <div className={styles.area}>
          <div className={styles.evalCol}>
            <Tooltip>
              ...
              <TooltipContent>eval (white): {whiteEval >= 0 ? '+' : ''}{whiteEval.toFixed(0)}</TooltipContent>
            </Tooltip>
            <div className={styles.evalReadout}><b>{leadTxt}</b><span>{winPct}% white</span></div>
          </div>
          <div
              ...
              colOrder.map((f) => {
                ...
                return (
                  ...
                  >
                    ...
                    {targets.has(sq) && <span className={styles.targetMu}>{fmtDelta(targetMu.get(sq))}</span>}
                  </div>
                );
              }),
            )}
