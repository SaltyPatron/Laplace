...
| SQL files | 552 |
| SQL lines | 26,160 |
| Auditable SQL units, including bodies and embedded SQL | 2,721 |
| Production SQL files | 492 |
| Production SQL lines | 19,910 |
| Production auditable units | 1,987 |
| Exact clone clusters | 12 |
| Near-clone clusters in the full run | 15 |
| Static findings, all roles | 605 |
...
|---|---:|
| Function interface with a numeric cap default | 104 |
...
The static pass finds 266 production SRF definitions without a `ROWS` clause.
