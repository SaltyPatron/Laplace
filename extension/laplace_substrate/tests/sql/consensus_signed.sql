...
BEGIN
    ...
    SELECT (consensus_fold(false, NULL, NULL, NULL, phi_trust, 1, s_conf,     NULL)).rating INTO mu_conf;
    SELECT (consensus_fold(false, NULL, NULL, NULL, phi_trust, 1, s_ref,      NULL)).rating INTO mu_ref;
    SELECT (consensus_fold(false, NULL, NULL, NULL, phi_trust, 1, s_draw,     NULL)).rating INTO mu_draw;
    SELECT (consensus_fold(false, NULL, NULL, NULL, phi_trust, 1, s_conf,     NULL)).rating INTO mu_trust;
    SELECT (consensus_fold(false, NULL, NULL, NULL, phi_crank, 1, s_conf,     NULL)).rating INTO mu_crank;
    SELECT (consensus_fold(false, NULL, NULL, NULL, phi_trust, 8, s_conf * 8, NULL)).rating INTO mu_many;
    SELECT (consensus_fold(false, NULL, NULL, NULL, phi_trust, 1, s_conf,     NULL)).rating INTO mu_one;
