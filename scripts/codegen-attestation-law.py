...
"""
    ...
    # Highway-axis partitions of consensus + attestations. The manifest is the
    # topology source; a topology change requires a fresh substrate and reseed.
    # Upgrade SQL must never detach, drain, or rewrite populated partitions.
