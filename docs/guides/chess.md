...
Stockfish comparator/teacher role, and cumulative strength/ablation protocol, see
...
- Recorder: literal headers, participants, result, the typed move trajectory, annotations,
  clocks, and source metadata. SAN/PGN is not recorded; it is generated by replay at the
  read edge.
