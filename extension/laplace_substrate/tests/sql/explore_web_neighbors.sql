...
BEGIN
    ...
    RAISE NOTICE '✓ explore_web_neighbors: scalar/batch/default-partition parity, distinct per-root limits, self-edge deduplication, and total tie order all hold';
END $$;
