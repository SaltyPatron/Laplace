...
[ADR 0028](0028-custom-built-pg-postgis-intel.md) was originally framed as parallel to Chunks 1-3 (deferrable). the design refinement makes it a hard prerequisite for two reasons:
