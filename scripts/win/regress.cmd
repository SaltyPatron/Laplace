...
"%PGREGRESS%" --bindir="%PGBIN%" --host=localhost --user=postgres ^
  ...
  bootstrap glicko2_aggregate entities_exist_bitmap consensus_signed consensus_period consensus_fold converse identity_law schema_law structural_surface
