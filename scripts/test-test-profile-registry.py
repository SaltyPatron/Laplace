...
POLICY_IDS = {
    ...
    "policy-chess-dependencies", "policy-stockfish-corpus", "policy-cutechess-release", "policy-cutechess-gui-session", "policy-chess-acceptance", "policy-chess-environment-benchmark",
