...
from ci_managed_graph import discover as discover_managed_projects
...
SUITE_SCOPES = {
    "native-dev": (
        ...
        "scripts/test-suites/common.sh",
        "scripts/test-suites/native-dev.sh",
    ...
    "managed-dev": (
        ...
        "scripts/test-parallel.sh",
        "scripts/test-suites/common.sh",
        "scripts/test-suites/managed-dev.sh",
        "scripts/sync-managed-native-artifacts.sh",
        "scripts/place-build-directory.py",
    ),
    "uci-dev": (
        "CMakeLists.txt",
        "Directory.Build.*",
        ...
        "scripts/test-parallel.sh",
        "scripts/test-suites/common.sh",
        "scripts/test-suites/uci-dev.sh",
        "scripts/sync-managed-native-artifacts.sh",
        "scripts/place-build-directory.py",
    ),
    "browser-dev": (
        ...
        "scripts/test-parallel.sh",
        "scripts/test-suites/common.sh",
        "scripts/test-suites/browser-dev.sh",
    ),
}
...
def managed_dependency_selectors(root: Path) -> tuple[str, ...]:
    ...
    while queue:
        ...
        seen.add(project)
        queue.extend(projects[project]["references"])

    return tuple(
        sorted({str(Path(project).parent.as_posix()) + "/" for project in seen})
    )
