...
"%PGREGRESS%" --bindir="%PGBIN%" --host=localhost --user=postgres ^
  ...
  bootstrap glicko2_aggregate entities_exist_bitmap consensus_signed consensus_upsert generation_corpus converse word_law identity_law schema_law structural_surface constituent_edges
