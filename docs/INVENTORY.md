...
## Native extension sources — 28 (`extension/laplace_substrate/src/`)
...
- Governed canonical relations: **211** (+23 aliases — aliases map to a canonical and add no highway bits)
