...
static ReadState state(void){ReadState s={0};static bool seen;seen=false;s.frontier_seen=&seen;s.maximum_bytes=64u*1024u*1024u;s.maximum_work=1000000;s.maximum_operations=128;return s;}
