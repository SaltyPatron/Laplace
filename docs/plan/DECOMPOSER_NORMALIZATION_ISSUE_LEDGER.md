...
| DN-24 | Clean bounded and full reseed proves correctness and speed | Proof pending | The pre-drop totals remain the before baseline. Clean runs measured Atomic2020 at 1,331,097 inputs / 414 seconds and pre-#1186 OMW at 3,438,843 inputs / 716.2 seconds. Chess run 32297973379 ingested 190,705 games in 1,065 seconds and replayed in seven seconds. Run 32300064613 ingested another 655,255 games in 3,655.1 seconds, folded 1,338,361,912 observations into 22,707,034 cells, and classified every nonphysical identity (`unexplained=0`); it also exposed the 815-second exact post-ingest scan removed by #1196. | [#433](https://github.com/SaltyPatron/Laplace/issues/433), [#761](https://github.com/SaltyPatron/Laplace/issues/761), [#1132](https://github.com/SaltyPatron/Laplace/issues/1132): remeasure Atomic/OMW after #1183/#1184/#1186, attribute chess's roughly 2,042 observations/game per relation, then complete bounded fixtures, reader parity, row/byte amplification, and the admitted full-seed envelope. |
