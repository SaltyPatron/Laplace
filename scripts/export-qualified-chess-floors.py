...
CANDIDATE = "4fa186e38de10ee5cc768d38f33ec9663cf2e314"
CANDIDATE_TREE = "8e5cde196b33dc2dbbc7a0d1643b26dd3b45f595"
INSTALLED_SOURCE = CANDIDATE
...
def qualification(plan, root):
    ...
    if (remote.get("id") != run_id or remote.get("status") != "completed"
            ...
            or remote.get("run_attempt") != attempt or remote.get("head_sha") != CANDIDATE):
