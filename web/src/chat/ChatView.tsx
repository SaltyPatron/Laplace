    ...
    <div className={styles.layout}>
      ...
      <section className={styles.main}>
        ...
        <div className={styles.toolbar}>
          ...
          <SegmentedControl
            label="Reply from"
            value={model.includes('converse') ? 'consensus' : 'generated'}
            options={['consensus', 'generated']}
            onValueChange={(v) =>
              setModel(v === 'consensus' ? 'laplace-converse-001' : 'laplace-completions-001')
            }
          />

          <Muted className={styles.modeHint}>
            {model.includes('converse')
              ? 'Answers are read from witnessed consensus, with μ and witness counts attached.'
              : 'Answers are generated by descending the trajectory graph from your prompt.'}
          </Muted>
