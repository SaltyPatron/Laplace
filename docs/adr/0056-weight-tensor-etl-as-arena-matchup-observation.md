...
- Tokenizer vocab ≈ 152K entries, but per [ADR 0047 TextDecomposer](0047-text-decomposer-pure-primitive.md) canonicalization (NFC + UAX#29 + BPE/SentencePiece/WordPiece marker stripping), aliases collapse to ~50–80K unique substrate text entities. Take ~50K as the working estimate.
