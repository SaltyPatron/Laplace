...
DECLARE
    ...
    w_of      bytea := laplace_hash128_blake3('test/corpus/word-of');
    w_france  bytea := laplace_hash128_blake3('test/corpus/word-france');
...
BEGIN
    ...
    VALUES (consensus_id(w_end, relation_type_id('COMPLETES_TO'), w_target),
