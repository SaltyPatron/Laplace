...
| DN-16 | FrameNet, PropBank, VerbNet, PredicateMatrix, and SemLink preserve occurrence and owner scope | Partial | #1152 binds roles/predicates to owning structures; #1161 retains FrameNet target spans and attests the occurrence; #1191 reads VerbNet 3.4 `fn_mapping` and preserves direct member-to-FrameNet mappings. | [#1153](https://github.com/SaltyPatron/Laplace/issues/1153): FrameNet FE layers/semantic types/core sets/valence, PropBank aliases/lexlinks/spans, VerbNet member keys/PB grouping/syntax/restrictions/complete arguments, and full PredicateMatrix columns/languages/PB alignment. |
...
| VerbNet | Scoped predicate occurrence and native `fn_mapping` delivered; preserve member keys/PB grouping/syntax/restrictions/complete arguments. | #1153 |
