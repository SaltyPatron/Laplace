...
--
-- UAX #29 keeps Latin, Cyrillic, Arabic, and Hangul words whole. Han,
-- Hiragana, Katakana, Thai, Lao, and Khmer arrive as characters. This
-- function joins a byte-contiguous run when that span is a stored entity.
-- Whitespace stays a boundary.
--
...
\timing on
SELECT * FROM generation.forward_text('The opposite of hot is',40,5,0.0,10,7);
ROLLBACK;
