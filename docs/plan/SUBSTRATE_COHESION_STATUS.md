...
| Native prepared set-sized SPI for hot paths | Partial | Several native batch/probe operations exist, but there is no complete SPI census or gate preventing per-row/unprepared execution. |
