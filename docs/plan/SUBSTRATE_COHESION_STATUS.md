...
| Early result reduction and honest top-k | Partial | `cluster`, `bubble_up`, `surface_sample`, angular KNN, global top relations, and band facts no longer hide guessed candidate multipliers. Remaining fixed limits and transport/operator caps still require classification. |
