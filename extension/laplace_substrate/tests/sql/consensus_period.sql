...
BEGIN
    ...
    INSERT INTO consensus_period_staging_0 (subject_id, type_id, object_id, phi, games, sum_score, last_ts) VALUES
        (subjA, rel_type, objA, phi, 2, s_conf * 2, now()),
        (subjB, rel_type, objB, phi, 3, s_ref  * 3, now());
    ...
    INSERT INTO consensus_period_staging_0 (subject_id, type_id, object_id, phi, games, sum_score, last_ts)
        VALUES (subjC, rel_type, objC, phi, 2, s_conf * 2, now());
    PERFORM materialize_period_consensus();
    SELECT rating, rd, witness_count INTO c1_r, c1_rd, c1_wc FROM consensus WHERE subject_id = subjC;

    PERFORM create_period_staging();
    INSERT INTO consensus_period_staging_0 (subject_id, type_id, object_id, phi, games, sum_score, last_ts)
        VALUES (subjC, rel_type, objC, phi, 3, s_conf * 3, now());
    PERFORM materialize_period_consensus();
    ...
    PERFORM create_period_staging();
    INSERT INTO consensus_period_staging_0 (subject_id, type_id, object_id, phi, games, sum_score, last_ts) VALUES
        (subjA, rel_type, objA, phi,  1, s_conf, now()),
        (subjA, rel_type, objA, phi2, 1, s_conf, now());
    BEGIN
        PERFORM materialize_period_consensus();
    ...
    PERFORM create_period_staging(2);
    INSERT INTO consensus_period_staging_0 (subject_id, type_id, object_id, phi, games, sum_score, last_ts)
        VALUES (subjC, rel_type, objC, phi, 1, s_conf, now());
    INSERT INTO consensus_period_staging_1 (subject_id, type_id, object_id, phi, games, sum_score, last_ts)
        VALUES (subjA, rel_type, objB, phi, 1, s_conf, now());
...
BEGIN
    ...
    EXECUTE format('INSERT INTO %I (subject_id, type_id, object_id, phi, games, sum_score, last_ts)
        ...
        USING subjD, rel_type, objD, phi, s_conf;
...
BEGIN
    ...
    VALUES (laplace_hash128_blake3('test/inband/phys'), word, 1,
