...
public class SourceIdPinTests
{
    public static readonly TheoryData<Func<IDecomposer>, string, string> Pins = new()
    {
        { () => new Laplace.Decomposers.Unicode.UnicodeDecomposer(),
          "909b825fe20bd201e70d8c8f6041ec50", "eb0687a0c121cd642fb5bf52d9094685" },
        { () => new Laplace.Decomposers.ISO.ISODecomposer(),
          "2e0404bdd15c7e19517f1f26d57e240b", "eb0687a0c121cd642fb5bf52d9094685" },
        { () => new Laplace.Decomposers.CILI.CILIDecomposer(),
          "e46123b3b4d43df4a41a95d750c310e1", "1255e5a0e069f554c032c0952680f491" },
        { () => new Laplace.Decomposers.WordNet.WordNetDecomposer(),
          "4b1ee33be3034910df7629b2948cde35", "eb0687a0c121cd642fb5bf52d9094685" },
        { () => new Laplace.Decomposers.OMW.OMWDecomposer(),
          "2d8df8e310d8c0bb26bb08837baf3756", "1255e5a0e069f554c032c0952680f491" },
        { () => new Laplace.Decomposers.VerbNet.VerbNetDecomposer(),
          "8ee60cfa49a7dff70dc87d6807d3b0a0", "1255e5a0e069f554c032c0952680f491" },
        { () => new Laplace.Decomposers.PropBank.PropBankDecomposer(),
          "d93e8179e24e146f9f0498d469073524", "1255e5a0e069f554c032c0952680f491" },
        { () => new Laplace.Decomposers.FrameNet.FrameNetDecomposer(),
          "650979dde48d38baa9e403f4739c1dc1", "1255e5a0e069f554c032c0952680f491" },
        { () => new Laplace.Decomposers.SemLink.MapNetDecomposer(),
          "74809dc2edd48bc97e10fee9ba466fca", "1255e5a0e069f554c032c0952680f491" },
        { () => new Laplace.Decomposers.SemLink.WordFrameNetDecomposer(),
          "6e012044174c4f0ac189bbf4cae40e74", "1255e5a0e069f554c032c0952680f491" },
        { () => new Laplace.Decomposers.SemLink.SemLinkDecomposer(),
          "8c1d82e7b9f338ddca954b6e0b8829c7", "1255e5a0e069f554c032c0952680f491" },
        { () => new Laplace.Decomposers.ConceptNet.ConceptNetDecomposer(),
          "7dd057136ea446aeb50d1bb840bdc0f0", "e39e42b9621d59b608d157aeffa52531" },
        ...
        { () => new Laplace.Decomposers.Atomic2020.Atomic2020Decomposer(),
          "affee556837b77b5562a026400aece2b", "f0fde7663a027b2ef1ac22edc9527c7b" },
        { () => new Laplace.Decomposers.Code.CodeDecomposer(),
          "c90645d6b0f228c684d95bbbc0b52a42", "f0fde7663a027b2ef1ac22edc9527c7b" },
        { () => new Laplace.Decomposers.Code.RepoDecomposer(),
          "d393ad78a7ccbee830504361f4dde050", "f0fde7663a027b2ef1ac22edc9527c7b" },
        { () => new Laplace.Decomposers.Code.StackDecomposer(),
          "6af57547662bbb37f4e13db9acfe3eed", "f0fde7663a027b2ef1ac22edc9527c7b" },
        { () => new Laplace.Decomposers.Code.TinyCodesDecomposer(),
          "584ccc3cce1291ad4ac04ce4f8b33a8c", "f0fde7663a027b2ef1ac22edc9527c7b" },
        { () => new Laplace.Decomposers.Code.TabularDecomposer(),
          "3f0876af5782433a4991d2d02e93b982", "f0fde7663a027b2ef1ac22edc9527c7b" },
        { () => new Laplace.Decomposers.AgentTrace.AgentTraceDecomposer(),
          "2695dfdb6ee5e398ac86cea7a87d1695", "2e13ee2cc22ef6d125d5c2139cea4509" },
    };
