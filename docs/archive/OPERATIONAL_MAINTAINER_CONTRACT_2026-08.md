> Historical branch document preserved during consolidation. Its issue statuses, completed-work claims, scheduled-task text, and workflow instructions are not verified current state. Current user instructions and the active repository contract govern.
