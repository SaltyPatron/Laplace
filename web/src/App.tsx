...
function Shell() {
  ...
  return <div className={styles.shell}>
    ...
    <main id="main-content" tabIndex={-1} className={styles.main}>
      <ViewErrorBoundary resetKey={JSON.stringify([tenant, location.key])}>
        <Routes key={tenant}>
          ...
          <Route path="*" element={<Panel title="Workspace not found">
            <p>This address does not match a Laplace workspace. Use the navigation above or return Home.</p>
